  ...
  <div>
    ...
    <div class="mb-10">
      <v-row class="justify-center">
        ...
        <div class="font-weight-bold">投稿したマシン情報</div>
        <v-divider class="border-opacity-90 mx-3" color="black" :thickness="1" vertical></v-divider>
		...
		<div class="mb-3">
			<div v-if="battingCenterAndMachines.length == 0">投稿したマシン情報はありません</div>
...
const { data, error, refresh } = await useUserApi().getMyPostedMachines()
